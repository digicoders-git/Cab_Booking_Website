  ...
  const terms = [
    {
      ...
      content: "By accessing or using KwikCabs  services, you agree to be bound by these Terms of Service. If you do not agree to all of these terms, do not use our app or website. These terms govern your use of our platform and the transportation services provided by our captains."
    },
    {
      icon: <FaCheckDouble />,
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="prose prose-lg max-w-none text-gray-500 mb-12 relative z-10">
              ...
              <p>
                Welcome to KwikCabs . These Terms of Service ("Terms") constitute a legally binding agreement between you and KwikCabs  regarding your use of our network of websites and mobile applications. By using our service, you acknowledge that you have read and understood these terms.
              </p>
            </div>
          ...
          <footer className="text-center pb-12">
            ...
            <a href="mailto:legal@KwikCabs .com" className="text-[#111111] font-black text-xl hover:text-primary transition-colors underline underline-offset-8">LEGAL@KwikCabs .COM</a>
          </footer>
        </div>
      </div>
    </div>
