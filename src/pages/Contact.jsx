...
const Contact = () => {
   ...
   const handleSubmit = (e) => {
      ...
      Swal.fire({
         ...
         text: 'Thank you for contacting KwikCabs ! Our team will get back to you soon.',
   ...
   const contactInfo = [
      ...
      },
      {
         icon: <FaEnvelope />,
         title: "Email Support",
         desc: "info@KwikCabs .com | support@KwikCabs .com",
   ...
   return (
      <div className="bg-[#fcfcfc] min-h-screen">
         <PageHeader title="Contact Us" subtitle="Get in touch with KwikCabs  — your most reliable cab service" />
