...
const PrivacyPolicy = () => {
  const sections = [
    ...
    },
    {
      icon: <FaRegFileAlt />,
      title: "Your Rights",
      content: "You have the right to access, update, or delete your personal information at any time. You can manage your notification preferences in the app settings. For any data-related inquiries, you can contact our dedicated privacy team at privacy@KwikCabs .com."
    }
  ];

  return (
    <div className="bg-[#fcfcfc] min-h-screen">
      <PageHeader title="Privacy Policy" subtitle="Your privacy is our top priority. Learn how KwikCabs  protects your data." />
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <div className="prose prose-lg max-w-none text-gray-500 mb-12">
              ...
              <p>
                At KwikCabs , we are committed to protecting your privacy. This Privacy Policy explains how we collect, use, and safeguard your personal information when you use our website and mobile application. By using our services, you agree to the practices described in this policy.
              </p>
            </div>
